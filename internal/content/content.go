...
func All() []challenge.Challenge {
	return []challenge.Challenge{
		...
		},
		{
			...
			Target: "★",
			Content: []string{
				"Use ) to jump forward to the next sentence.",
				"",
		...
		},
		{
			...
			Target: "★",
			Content: []string{
				"Use ; to repeat your last find and reach the next star.",
				"",
				"★  ★  ★  ★  ★  ★  ★  ★  ★",
			},
			Layer: "Tutorial",
		...
		},
		{
			...
			Target: "★",
			Content: []string{
				"Use } to jump forward to the next paragraph.",
				"",
				"first paragraph",
				"",
				"second paragraph",
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use f{char} then diw to delete the word.",
				"",
				"keep delete keep",
			},
			Result: []string{
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use f{char} then daw to delete around the word.",
				"",
				"keep delete keep",
			},
			Result: []string{
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use f{char} then di( to delete inside the parentheses.",
				"",
				"func(remove)",
			},
			Result: []string{
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use f{char} then ca\" to change around the quotes.",
				"",
				"\"remove\"",
			},
			Result: []string{
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use f{char} then ciw to change the word.",
				"",
				"keep delete keep",
			},
			Result: []string{
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use dw then . to delete the remaining words.",
				"",
				"one two three four",
			},
			Result: []string{
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use ciw then . to change the remaining words.",
				"",
				"one two three",
			},
			Result: []string{
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use yy then p to duplicate the line below.",
				"",
				"alpha",
				"beta",
			},
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use dd then p to move the line to the end.",
				"",
				"one",
				"TWO",
				"three",
		...
		},
		{
			...
			Verify: "composite",
			Content: []string{
				"Use dd then P to swap the two lines.",
				"",
				"first",
				"second",
			},
